                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Work Add Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('work.store')}}"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  name="work_title" class="form-control @error('work_title') is-invalid @enderror">
                                @error('work_title')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
