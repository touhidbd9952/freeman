            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="woner_id" id="wonerList" autocomplete="off" class="form-control @error('woner_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{$woner->id}}">Name:&nbsp;{{ $woner->name_en }}&nbsp;,phone:&nbsp;{{ $woner->phone1 }}</option>
                                    @endforeach
                                </select>
                        ...
                        <input type="hidden" name="long_description_jp" value="Details Description (JP)">
                        {{-- <div class="form-group row">
                            <label for="fname"
...
<script>
  ...
  <script>
    ...
    {  
      ...
      var youtubevideolink = document.getElementById('youtubevideolink').value;   
